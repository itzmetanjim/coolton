    ...
    try:
        ...
        if feedback_value == "good-feedback":
            client.chat_postEphemeral(
                ...
                text="Glad that was helpful! (note: i didnt actually make these buttons do anything yet :pf: )",
            )
        else:
            client.chat_postEphemeral(
                channel=channel_id,
                user=user_id,
                thread_ts=message_ts,
                text="Sorry that wasn't helpful. :slightly_frowning_face: Try rephrasing your question and I'll give it another shot.(note: i didnt actually make these buttons do anything yet :pf: )",
            )
