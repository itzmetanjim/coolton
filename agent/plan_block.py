...
TOOL_DISPLAY_NAMES = {
    ...
    "edit_sandbox_file_tool": "Editing sandbox file",
    "search_sandbox_files_tool": "Searching sandbox files",
    "list_sandbox_files_tool": "Listing sandbox files",
    "run_background_command_tool": "Starting background command",
    "check_background_command_tool": "Checking background command",
    "kill_background_command_tool": "Stopping background command",
